    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row + 1 > cellList.count {
            ...
            cell.videoView.load(URLRequest(url: url))
            ...
            cell.videoView.navigationDelegate = self
            return cell
        }
        else {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        else if title.count > 45 {
            return self.view.frame.size.height/2 * 0.8
        }
        else {
            return self.view.frame.size.height/2 * 0.6
        }
    }
