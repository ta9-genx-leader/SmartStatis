...
class HomePageController: UIViewController, UITableViewDelegate, UITableViewDataSource ,UIPopoverPresentationControllerDelegate,FoodDetailDelegate,PopOverDelegate,UIImagePickerControllerDelegate, UINavigationControllerDelegate, NewFoodlDelegate,ScanReceiptDelegate,NextFoodIdDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        if let pickedImage = info[UIImagePickerController.InfoKey.originalImage] as? UIImage {
            ...
            dismiss(animated: true, completion: {
                ...
                postRequest.addValue(HttpUrl().imgurClientId, forHTTPHeaderField: "Authorization")
                    ...
                    if data != nil && !self.timeOut
                    {
                        ...
                        else
                        {
                            do {
                                ...
                                let uploadUrlString = HttpUrl().updateReceipt + "?url=" + imageUrl + "&uid=" + String(self.currentUser!.userId!)
    ...
    func downloadData() {
        ...
        let foodURL = HttpUrl().getFoodById + "?id=" + String(userId)
    ...
    func downloadCategory() {
        let categoryURL = HttpUrl().getAllCategory
...
extension UIViewController{
    ...
    func addNewFood(userId:String,cateId:String,locationId:String,foodName:String,start:String,price:String,expire:String) {
        guard let postUrl = URL(string: HttpUrl().addFood + "?uid=" + String(userId) + "&cid=" + String(cateId) + "&lid=" + String(locationId) + "&name=" + foodName.replacingOccurrences(of: " ", with: "_") + "&start=" + start + "&price=" + price + "&expire=" + expire ) else { return}
    ...
    func deleteFoodRequest(foodId: Int?) {
        guard let foodURL = URL(string: HttpUrl().deleteFood + "?id=" + String(foodId!)) else {return}
