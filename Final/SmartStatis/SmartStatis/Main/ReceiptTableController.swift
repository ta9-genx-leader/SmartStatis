...
class ReceiptTableController: UITableViewController,FoodDetailDelegate {
    ...
    */
    ...
    func uploadReceipt(foodId:String,userId:String,cateId:String,locationId:String,foodName:String,start:String,price:String,expire:String,keyword:String) {
        let urlString = HttpUrl().addFoodWithIdAndKeyword + "?id=" + foodId + "&uid=" + String(userId) + "&cid=" + String(cateId) + "&lid=" + String(locationId) + "&name=" + foodName.replacingOccurrences(of: " ", with: "_").replacingOccurrences(of: "%", with: "") + "&start=" + start + "&price=" + price + "&expire=" + expire + "&keyword=" + keyword
